...
<table width="1002" height="1108" border="0" align="center" cellpadding="0" cellspacing="0" id="__01">
   ...
   <input type="submit" name="Submit" value="查找" style='border:solid 1px #000000; color:#666666' /> <input type="button" name="Submit5" value="切换视图"  style='border:solid 1px #000000; color:#666666' onClick="javascript:location.href='jiudianxinxilisttp.jsp';" />
</form>
<table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bordercolor="00FFFF" style="border-collapse:collapse" class="newsline">  
  ...
  <% 
    ...
    String url = "jiudianxinxilist.jsp?2=2"; 
...
if (request.getParameter("junjia2")==""  ||request.getParameter("junjia2")==null ) {}else {sql=sql+" and junjia <= '"+request.getParameter("junjia2")+"'";}
  ...
  <tr>
    ...
    <td><%=map.get("bianhao") %></td><td><%=map.get("mingcheng") %></td><td width='90'><a href='<%=map.get("tupian") %>' target='_blank'><img src='<%=map.get("tupian") %>' width=88 height=99 border=0 /></a></td><td><%=map.get("xingji") %></td><td><%=map.get("chengshi") %></td><td><%=map.get("junjia") %></td>
    
    <td width="30" align="center"> <a href="jiudianxinxidetail.jsp?id=<%=map.get("id")%>" >详细</a></td>
  </tr>
  	<%
  }
   %>
