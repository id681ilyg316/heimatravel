...
<html>
  ...
  <form name="form1" id="form1" action="">
   ...
   <input type="submit" name="Submit" value="查找" style='border:solid 1px #000000; color:#666666' /> <input type="button" name="Submit2" value="导出EXCEL" style='border:solid 1px #000000; color:#666666' onClick="javascript:location.href='xianludingdan_listxls.jsp';" />
</form>
...
if(request.getParameter("chufadi")=="" ||request.getParameter("chufadi")==null ){}else{sql=sql+" and chufadi like '%"+request.getParameter("chufadi")+"%'";}
  ...
  <tr>
    ...
    <td width="60" align="center"><a href="xianludingdan_updt.jsp?id=<%=map.get("id")%>">修改</a>  <a href="xianludingdan_list.jsp?scid=<%=map.get("id") %>" onClick="return confirm('真的要删除？')">删除</a> <a href="xianludingdan_detail.jsp?id=<%=map.get("id")%>">详细</a> </td>
  </tr>
  	<%
  }
   %>
