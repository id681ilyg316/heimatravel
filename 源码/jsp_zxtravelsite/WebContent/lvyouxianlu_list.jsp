...
<!--hxsglxiangdxongjxs-->
  ...
  <form name="form1" id="form1" action="">
   ...
   <input type="submit" name="Submit" value="查找" style='border:solid 1px #000000; color:#666666' /> <input type="button" name="Submit2" value="导出EXCEL" style='border:solid 1px #000000; color:#666666' onClick="javascript:location.href='lvyouxianlu_listxls.jsp';" />
</form>
...
//youzuiping2
  ...
  <tr>
	...
	<td width="90" align="center"><a href="pinglun_list.jsp?id=<%=map.get("id")%>&biao=lvyouxianlu">评论管理</a></td>
    <td width="138" align="center"><%=map.get("addtime") %></td>
    <td width="120" align="center"><a href="xianludingdan_add.jsp?id=<%=map.get("id")%>">发送订单</a>  <a href="lvyouxianlu_list.jsp?scid=<%=map.get("id") %>" onClick="return confirm('真的要删除？')">删除</a> <a href="lvyouxianludetail.jsp?id=<%=map.get("id")%>" target="_blank">详细</a> </td>
  </tr>
  	<%
  }
   %>
