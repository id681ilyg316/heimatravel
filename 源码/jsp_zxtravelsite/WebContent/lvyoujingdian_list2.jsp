...
//txixixngdy
    ...
    String url = "lvyoujingdian_list2.jsp?1=1"; 
    String sql =  "select * from lvyoujingdian where kaifangshijian='"+request.getSession().getAttribute("username")+"' ";
...
//youzuiping2
 ...
 <td width='80' align='center'><%=map.get("issh")%></td>
    ...
    <td width="60" align="center"><a href="lvyoujingdian_updt.jsp?id=<%=map.get("id")%>">修改</a>  <a href="lvyoujingdian_list2.jsp?scid=<%=map.get("id") %>" onClick="return confirm('真的要删除？')">删除</a> <a href="lvyoujingdiandetail.jsp?id=<%=map.get("id")%>" target="_blank">详细</a> </td>
  </tr>
  	<%
  }
   %>
